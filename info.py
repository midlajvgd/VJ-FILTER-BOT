...
API_ID = int(environ.get('API_ID', '7869098549'))
API_HASH = environ.get('API_HASH', '0aa6296a378ea53b80d4f41575af3e4c')
BOT_TOKEN = environ.get('BOT_TOKEN', "7869098549:AAEH1uJNtBpo-RoeYoWVAAnqoBxhkwmQRIY")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6926899190').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002520686208'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002675992770').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002584804001') # give your force subscribe channel id here else leave it blank
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mjfilterbot:mjfilterbot@cluster0.0tb46pu.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+RWyhtNtU0sE0MDg1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+Pnk7uqdfWo40OGI1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'vj_bot_disscussion') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/mjhere007')
